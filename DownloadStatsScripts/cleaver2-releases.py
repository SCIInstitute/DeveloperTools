...
parser.add_option("--windows",                                   
                  dest="win32",action='store_true', default=False,
...
with urllib.request.urlopen("https://api.github.com/repos/SCIInstitute/Cleaver2/releases") as response:
   html = response.read()
#data = urllib2.urlopen("https://api.github.com/repos/SCIInstitute/Cleaver2/releases")
#html = data.read()
