...
os_version = ['osx', 'win64']
version_num = ['v2.15.1','v2.15.2','v2.15.3','v2.16','v2.17','v2.18']


with urllib.request.urlopen("https://api.github.com/repos/SCIInstitute/fluorender/releases") as response:
   html = response.read()
   
#data = urllib2.urlopen("https://api.github.com/repos/SCIInstitute/fluorender/releases")
#html = data.read()
